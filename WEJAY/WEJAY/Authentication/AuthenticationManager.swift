...
extension AuthenticationManager {
    ...
    @discardableResult
    func createUser(email: String, password: String, firstName: String? = nil, lastName: String? = nil) async throws -> AuthDataResultModel {
        let authDataResult = try await Auth.auth().createUser(withEmail: email, password: password)
        return AuthDataResultModel(user: authDataResult.user, firstName: firstName, lastName: lastName)
    }
    
    @discardableResult
    func signInUser(email: String, password: String, firstName: String, lastName: String) async throws -> AuthDataResultModel {
